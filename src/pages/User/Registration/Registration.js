...
const Registration = () => {
 ...
 // const [gioitinh,gioitinhChange] = useState("");
  ...
  const handlesubmit = async (e) => {
     ...
     await axios.post('http://localhost:5000/customer/register', {
        hoten,
        email,
        dienthoai: phone,
        password,
      ...
      <form action="#" onSubmit={handlesubmit}>
        <div className="user-details">
          <div className="input-box">
            ...
            <input type="text" placeholder="Enter your name" required value={hoten} onChange={(e) => hotenChange(e.target.value)}/>
          </div>
          <div className="input-box">
            <span className="details">Date of birth</span>
             <input type="date" placeholder="Enter your Gender" required value={ngaysinh} onChange={(e) => ngaysinhChange(e.target.value)} />
          ...
          <div className="input-box">
            ...
            <input type="email" placeholder="Enter your email" required value={email} onChange={(e) => emailChange(e.target.value)}/>
          </div>
          <div className="input-box">
          ...
          <div className="input-box">
            ...
            <div className='p-relative'>
              <input type={showPassword1 ? 'text' : 'password'} placeholder="Password" required value={password} onChange={(e) => passwordChange(e.target.value)}/>

              <div className='eye'>
                {!showPassword1 ?
                  <FontAwesomeIcon icon={faEye} style={{ cursor: 'pointer' }} onClick={() => showPassword1Change(true)} />
                 : <FontAwesomeIcon icon={faEyeSlash} style={{ cursor: 'pointer' }} onClick={() => showPassword1Change(false)} />
                 }
              </div>
            </div>
          </div>
          <div className="input-box">
            ...
            <div className='p-relative'>
              <input type={showPassword ? 'text' : 'password'} placeholder="Confirm your password" required value={Confirm} onChange={validate}/>
        ...
        <div className="button">
          ...
          <center><Link to="/Login" className="L">Login</Link></center>
        </div>
      </form>
    </div>
  </div>
